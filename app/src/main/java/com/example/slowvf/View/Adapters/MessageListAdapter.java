...
public class MessageListAdapter extends RecyclerView.Adapter {
    ...
    private List<InAppMessage> mMessageList;

    private String correspondant;

    public MessageListAdapter(Context context, List<InAppMessage> messageList, String inCorrespondant) throws IOException {
        mContext = context;
    ...
    public int getItemViewType(int position) {
        InAppMessage message = (InAppMessage) mMessageList.get(position);
    ...
    private class SentMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(InAppMessage message) {
